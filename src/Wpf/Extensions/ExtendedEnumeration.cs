...
namespace Phoenix.UI.Wpf.Extensions
{
	/// <summary>
	/// Internally used by <see cref="EnumToCollectionConverter"/> for building the <see cref="EnumDescription"/> collection.
	/// </summary>
	...
	/// </summary>
	/// <remarks> This is used by the <see cref="EnumToCollectionConverter"/>. </remarks>
