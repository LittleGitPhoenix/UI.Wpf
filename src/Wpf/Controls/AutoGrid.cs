...
namespace Phoenix.UI.Wpf.Controls
{
	...
	public class AutoGrid : Grid
	{
		...
		/// <summary> AutoIndex attached property. </summary>
		...
		public static readonly DependencyProperty RowHeightOverrideProperty = DependencyProperty.RegisterAttached("RowHeightOverride", typeof(GridLength?), typeof(AutoGrid), new FrameworkPropertyMetadata(default(GridLength?), FrameworkPropertyMetadataOptions.AffectsParentMeasure | FrameworkPropertyMetadataOptions.AffectsArrange | FrameworkPropertyMetadataOptions.AffectsMeasure));
		...
		public static readonly DependencyProperty ColumnWidthOverrideProperty = DependencyProperty.RegisterAttached("ColumnWidthOverride", typeof(GridLength?), typeof(AutoGrid), new FrameworkPropertyMetadata(default(GridLength?), FrameworkPropertyMetadataOptions.AffectsParentMeasure | FrameworkPropertyMetadataOptions.AffectsArrange | FrameworkPropertyMetadataOptions.AffectsMeasure));
		...
		(
			name: nameof(ChildHorizontalAlignment),
			...
			(
				...
				propertyChangedCallback: new PropertyChangedCallback(OnChildHorizontalAlignmentChanged)
			)
		);
		...
		/// </summary>
		public static void ColumnCountChanged(DependencyObject dependencyObject, DependencyPropertyChangedEventArgs args)
		{
			if ((int) args.NewValue < 0) return;

			var grid = dependencyObject as AutoGrid;

			// look for an existing column definition for the height
			var width = GridLength.Auto;
			if (grid.ColumnDefinitions.Count > 0) width = grid.ColumnDefinitions[0].Width;
		...
		/// <summary>
		/// Parse an array of grid lengths from a comma delimited text.
		/// </summary>
