...
namespace Phoenix.UI.Wpf.Base.Converters
{
	...
	public class EnumEqualsConverter : SourceValueConverter<EnumEqualsConverter>
	{
		/// <inheritdoc />
	...
	/// </summary>
	public class EnumNotEqualsConverter : SourceValueConverter<EnumNotEqualsConverter>
	{
		/// <inheritdoc />
		public override object Convert(object value, Type targetType, object parameter, CultureInfo culture)
		{
	...
	/// </summary>
	public class EnumEqualsToVisibilityConverter : SourceValueToVisibilityConverter<EnumEqualsToVisibilityConverter>
	{
		/// <inheritdoc />
		public override object Convert(object value, Type targetType, object parameter, CultureInfo culture)
		{
